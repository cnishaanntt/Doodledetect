...
var email = (mailer, res) =>{	
    ...
    let message = {
        ...
        html: '<p>Dear Friend, </p><p><i>Celebrate </i> your loved ones <b>imagination</b> at https://pottercharm.herokuapp.com/grant?username='+mailer.receiverEmailId.substring(0, mailer.receiverEmailId.lastIndexOf("@"))+ '&domain='+mailer.receiverEmailId.substring(mailer.receiverEmailId.lastIndexOf("@") +1)+'. Click Home to find yours....</p><p>Get some <i>inspiration </i> from  https://www.youtube.com/watch?v=0URpDxIjZrQ</p> <p>Like us at https://devpost.com/software/zauber </p><br/><p>Cheers,</p><p>Expecto*</p>'			   
    };
